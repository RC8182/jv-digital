// src/app/api/dashboard/invoices/[id]/route.js
...
// EXPORTAR explícitamente la función PUT
export async function PUT(request, { params }) {
  ...
  const updated = await prisma.invoice.update({
    ...
    data: {
      ...
      total,
      lines: {
        // Primero eliminar todas las líneas existentes y luego crear las nuevas
        deleteMany: { invoiceId: id }, // Borra todas las líneas asociadas a esta factura
